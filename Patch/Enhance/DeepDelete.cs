    ...
    public static class DeepDelete {
        ...
        private static void Patch() {
            ...
            if (deleteItem4Args != null)
                harmony.Patch(
                    deleteItem4Args,
                    new HarmonyMethod(typeof(DeepDelete), nameof(DeleteItem4Prefix)),
        ...
        private static DeepDeleteState PrepareState(ILibraryManager libraryManager, BaseItem item,
            DeleteOptions options) {
            if (!isEnabled) return null;

            if (options == null || item == null || Plugin.LibraryService == null) return null;
